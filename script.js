document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function ti render the game board on the UI 
    ...
    function placeRandom() {
        ...
        if(available.length > 0) {
            ...
            cell.classList.add('new-tile'); // Animation for the new tiles
        }
    }

    // Function to move the tiles based on the arrow key input
    ...
    // Function to transform a line (row or column) based on the move direction
